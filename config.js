...
module.exports = {
  ...
  INTRO_TITLE: '🪪 Procédure d\'identification — GIGN',
  INTRO_MESSAGE:
    'Bienvenue dans la procédure d\'identification du **GIGN**.\n\n' +
    ...
    'Cliquez ci-dessous pour ouvrir le formulaire d\'identification.',
  INTRO_COLOR: '#0b2545',
  INTRO_FOOTER: 'Gendarmerie Nationale — GIGN RP',
  ...
  NICKNAME_FORMAT: 'NIGEND {nigend}', // devient le nouveau pseudo de la personne
  ...
  CONFIRM_MESSAGE:
    ...
    'Votre matricule **NIGEND** a été généré : **{nigend}**\n\n' +
  ...
  CONFIRM_NICKNAME_FAILED_NOTE:
    '\n\n⚠️ Votre pseudo n\'a pas pu être modifié automatiquement (permissions insuffisantes). ' +
    'Un gradé devra le faire manuellement.',
  ALREADY_REGISTERED_MESSAGE:
    'Vous êtes déjà identifié(e) : **{prenom} {nom}** — matricule **NIGEND {nigend}**.',

  // --- Annonce publique (si INTEGRATION_ANNOUNCE_CHANNEL_ID est défini) ------
  ANNOUNCE_TITLE: '🪖 Nouvelle intégration confirmée',
  ANNOUNCE_MESSAGE: '{user} a validé son identification. Matricule attribué : **NIGEND {nigend}**.',
  ANNOUNCE_COLOR: '#0b2545',
  ANNOUNCE_FOOTER: 'Gendarmerie Nationale — GIGN RP',
};
